...
import { User, FileText, Bug, Trophy, Settings, LayoutDashboard, LogOut } from "lucide-react"
    ...
    <div className="w-64 bg-sidebar border-r border-sidebar-border min-h-screen flex flex-col">
      <div className="p-6 flex-1">
        <div className="flex items-center space-x-2 mb-8">
          ...
          <div>
            <h2 className="text-lg font-bold text-sidebar-foreground">VunEat</h2>
        ...
        <nav className="space-y-2">
          {sidebarItems.map((item) => {
            ...
            const isActive =
              pathname === item.href || (item.href === "/users/reports" && pathname.startsWith("/users/reports"))
